                ...
                files: [
                    {
                        src: [
                            ...
                            '<%= config.srcPath %>angular-schema-form-select2/dist/bootstrap-select2.js',
                            '<%= config.srcPath %>angular-schema-form-simple-select2/dist/bootstrap-simple-select2.js',
                            '<%= config.srcPath %>angular-schema-form-datetimepicker/dist/bootstrap-datetimepicker.js',
                            '<%= config.srcPath %>angular-schema-form-new-image/dist/bootstrap-new-imageinjector.js',
                            '<%= config.srcPath %>angular-schema-form-image/dist/bootstrap-imageinjector.js',
                            '<%= config.srcPath %>angular-schema-form-file/dist/bootstrap-fileinjector.js',
                            '<%= config.srcPath %>angular-schema-form-mixed/dist/bootstrap-mixed.js',
                            '<%= config.srcPath %>angular-schema-form-button/dist/bootstrap-button.js',
                            '<%= config.srcPath %>angular-schema-form-textarea/dist/bootstrap-textarea.js',
                            '<%= config.srcPath %>angular-schema-form-password/dist/bootstrap-password.js',
                            '<%= config.srcPath %>angular-schema-form-seconds/dist/bootstrap-seconds.js',
                            '<%= config.srcPath %>angular-schema-form-multiselect/dist/bootstrap-multiselect.js',
                            '<%= config.srcPath %>angular-schema-form-rating/dist/bootstrap-rating.js',
                            '<%= config.srcPath %>angular-schema-form-ritinymce/bootstrap-ritinymce.js',
