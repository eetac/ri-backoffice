/*! ri-backoffice ri-backoffice 2017-01-31 */
...
(function() {
    "use strict";
    var app = angular.module("injectorApp", [ "ngRoute", "ngBiscuit", "schemaForm", "datePicker", "ui.select", "ui.ace", "ui.codemirror", "ui.bootstrap", "ngFileUpload", "ngDroplet", "punchCard", "nvd3ChartDirectives", "flash", "ngDialog", "angular-loading-bar", "pascalprecht.translate", "ngCookies", "ui.tinymce" ], [ "$rootScopeProvider", function($rootScopeProvider) {
...
(function() {
    "use strict";
    angular.module("injectorApp").controller("CreateController", [ "$scope", "$http", "$location", "$routeParams", "models", "$controller", function($scope, $http, $location, $routeParams, models, $controller) {
        var modelName = $routeParams.schema;
        $scope.action = "create";
        models.getModel(modelName, function(m) {
            if (!m.config.post) {
...
(function() {
    "use strict";
    angular.module("injectorApp").controller("UpdateController", [ "$scope", "$http", "$routeParams", "$location", "models", "$controller", function($scope, $http, $routeParams, $location, models, $controller) {
        var modelName = $routeParams.schema;
